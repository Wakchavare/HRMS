		...
		<div class="slider">
			<div class="callbacks_container">
				  <ul class="rslides" id="slider">
						 <li>	          
							<h3>A joint venture by<span>Pooja/Muskan/Asmita</span> </h3>
						 </li>
						 <li>	          
							<h3>Our hotel booking system is dedicated to helping you find the perfect accommodation for your travel needs. <span></span> </h3>  
						 </li>
						 <li>	          
							 <h3>With our user-friendly platform, you can easily discover and book the ideal stay that meets your preferences and budget.<span></span> </h3>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="container">
						<h3>Services</h3>
							<div class="features-grids">
								<?php
$sql="SELECT * from tblfacility order by ID ASC limit 4";
