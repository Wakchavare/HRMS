...
$sql="insert into tblbooking(RoomId,BookingNumber,UserID,IDType,Gender,StreetName,City,State,ZipCode,CheckinDate,CheckoutDate)values(:rid,:booknum,:uid,:idtype,:gender,:streetName,:city,:state,:zipCode,:checkindate,:checkoutdate)";
...
<html>
<head>
<title>Hotel Reservation Management System | Hotel :: Book Room</title>
...
{               ?>
								...
								<h5>Street Name</h5>
								<input type="text" name="streetName" required="true">
								<h5>City</h5>
								<input type="text" name="city" required="true">
								<h5>State</h5>
								<select  type="text" value="" class="form-control" name="state" required="true" class="form-control">	
								...
								<h5>Zip Code</h5>
								<input type="text" value="" class="form-control" name="zipCode" required="true">
								<h5>Checkin Date</h5>
